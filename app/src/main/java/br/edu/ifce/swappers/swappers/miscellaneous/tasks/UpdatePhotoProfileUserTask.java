 ...
 */
public class UpdatePhotoProfileUserTask extends AsyncTask<User,Void, Integer> {
    private Context context;
    private ProgressDialog progressDialog;
    private UpdateImageTaskInterface updateImageTaskInterface;

    public UpdatePhotoProfileUserTask(Context context, UpdateImageTaskInterface updateImageTaskInterface) {
    ...
    protected Integer doInBackground(User... params) {
        return UserService.updatePhotoProfileUserService(params[0]);
    }
    ...
    protected void onPostExecute(Integer status_code) {
        ...
        if(status_code== HttpURLConnection.HTTP_OK){
            this.updateImageTaskInterface.onUpdateImageProfileHadFinished();
